namespace cnMaestroReporting.SNMP
{
    ...
    public static class OIDs
    {
        ...
        public const string 
            ...
            antennaGain = _cambiumGenConfig + "14.0",
            filterPPPoE = _cambiumGenConfig + "125.0",
            filterAllIpv4 = _cambiumGenConfig + "132.0",
            filterAllIpv6 = _cambiumGenConfig + "160.0",
            filterArp = _cambiumGenConfig + "133.0",
            filterAllOther = _cambiumGenConfig + "134.0",
            filterDirection = _cambiumGenConfig + "147.0",
